            ...
            <div class="row">
                <div class="container-fluid bg-dark">
                    <div class="container-fluid d-flex justify-content-around bg-white mt-2 mb-2 ">
                        ...
                        <a href="{{route('menu')}}"><h3 class="my-auto" style="padding-top: 10%">{{__('header.menu') }}</h3></a>
                        <a href="#" data-bs-toggle="modal" data-bs-target="#ModalFormula"><h3 class="my-auto" style="padding-top: 5%">{{__('header.ourFormulas') }}</h3></a>
                        <a href="#"><h3 class="my-auto" style="padding-top: 4.5%">{{__('header.ourPromotions') }}</h3></a>
                        <a href="{{route('cmd details')}}"><h3 class="my-auto" style="padding-top: 5%">{{__('header.shoppingCart') }}</h3></a>
                        <a href="{{route('login')}}"><h3 class="my-auto" style="padding-top: 12.5%">{{__('header.login') }}</h3></a>
                    </div>
                </div>
